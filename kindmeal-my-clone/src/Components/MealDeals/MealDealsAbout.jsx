        ...
        <div className={styles.aboutsection}>
            <div className={styles.aboutsectiondiv} >
                ...
                <p className={styles.smallelements}>
                    Browse delicious meat-free, vegetarian deals from top restaurants and cafes!
                    Just click on "Get Free Coupon" to obtain instant discounts and dine at the
                    restaurants. No upfront payment, booking or printing is needed.
                    If you share it on social media, you'll even DOUBLE your discount!
                </p>
                <p className={styles.smallelements}>
                    Download our mobile app now to easily get coupons and start dining in
                    a few seconds. Effortlessly save lives, health, environment and money now!
                </p>
            </div>
            <div className={styles.searchdiv}>
                <input className={styles.search} placeholder='Search Shop or Deal Name' />
                ...
                <button className={styles.button} style={{ "backgroundColor": "rgb(245,56,56)" }}>Search Deals</button>
                <button className={styles.button} style={{ "backgroundColor": "rgb(4,190,90)" }}>Browse Restaurants</button>
